...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="animate-wa-pulse fixed bottom-6 right-6 z-[200] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] transition-transform hover:scale-110"
    >
