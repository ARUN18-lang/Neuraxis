...
export const whyNeuraxis = [
  {
    ...
    desc: "No bloated agencies, no handoff chaos. A tight crew of senior engineers owning your product end to end.",
  },
  {
    num: "02",
    title: "Cross-Domain Expertise",
    desc: "Hardware, software, and AI under one roof. We connect the dots others can't even see.",
  },
  {
    num: "03",
    title: "Startup Speed",
    desc: "We move at the pace of your ambition — fast iterations, real shipping, zero bureaucracy.",
  },
];
...
export const marqueeWords = [
  "Hardware", "Web", "Mobile", "AI / ML", "Automation",
  "Embedded Systems", "LLM Integration", "Full-Stack", "IoT", "Process Automation",
];
